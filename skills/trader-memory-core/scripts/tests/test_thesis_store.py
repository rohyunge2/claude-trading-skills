...
def test_update_rejects_non_review_outcome_writes_atomically(tmp_path: Path, outcome_payload):
    """P&L lifecycle fields, unknown keys, and replacements fail closed."""
